...
1. [What Is 'Human-In-The-Loop' And Why It Matters For AI In Finance](https://www.forbes.com/sites/christerholloman/2025/09/10/what-is-human-in-the-loop-and-why-it-matters-for-ai-in-finance/) - Human in the loop AI helps banks balance automation with trust, compliance and adaptability. Learn h...

2. [Counterfactual Value Estimation Using Outcome Imputation by Li ...](https://causalml.readthedocs.io/en/latest/examples/counterfactual_value_optimization.html) - The Causal ML package includes the CounterfactualValueEstimator class to conduct simple imputation-b...

3. [Using Machine Learning to Estimate Causal Effects from ...](https://stats.stackexchange.com/questions/406560/using-machine-learning-to-estimate-causal-effects-from-observational-data) - Basically, it estimates a parametric model for the counterfactual outcomes, then de-biases the estim...

4. [Online Learning and Regret Minimization](https://donskerclass.github.io/Forecasting/OnlineLearning.html) - An algorithm with low regret performs nearly as well as the best rule in the baseline set in hindsig...

5. [Regret Analysis: a control perspective - arXiv](https://arxiv.org/html/2501.04572v2) - Regret is defined as the cumulative loss (cost) over time from the online algorithm minus the cumula...

6. [No-Regret Online Learning Algorithm - GM-RKB - Gabor Melli](http://www.gabormelli.com/RKB/No-Regret_Online_Learning_Algorithm) - A No-Regret Online Learning Algorithm is an online learning algorithm that provides theoretical guar...

7. [Brier score - Wikipedia](https://en.wikipedia.org/wiki/Brier_score) - The Brier score is a strictly proper scoring rule that measures the accuracy of probabilistic predic...

8. [Brier Score in Machine Learning: Definition and Use Cases](https://howtolearnmachinelearning.com/articles/brier-score/) - The Brier Score is a scoring rule used to measure the accuracy of probabilistic predictions. Named a...

9. [Confidence Calibration for Deep Networks: Why and How?](https://cameronrwolfe.substack.com/p/confidence-calibration-for-deep-networks-why-and-how-e2cd4fe4a086) - The Brier Score (BS) is a proper scoring rule that measures the squared error between a predicted pr...

10. [Model Calibration, Explained: A Visual Guide with Code Examples ...](https://towardsdatascience.com/model-calibration-explained-a-visual-guide-with-code-examples-for-beginners-55f368bafe72/) - A high Brier Score suggests overall poor probability estimates. High Log Loss points to overconfiden...

11. [AI in banking: Why human bankers are still essential - Backbase](https://www.backbase.com/blog/human-in-the-loop) - Human-in-the-loop AI lets banks automate routine decisions while routing complex, high-stakes cases ...

12. [Why Human-in-the-Loop AI Matters in Financial Services](https://fulcrumdigital.com/blogs/human-in-the-loop-in-financial-services-isnt-a-limitation-its-a-risk-control-system/) - Understand how human-in-the-loop systems in finance act as crucial risk control mechanisms enhancing...

13. [High-level summary of the AI Act | EU Artificial Intelligence Act](https://artificialintelligenceact.eu/high-level-summary/) - Requirements for providers of high-risk AI systems (Art. 8–17). High risk AI providers must: Establi...

14. [EU AI Act Compliance Guide: Deadlines & High-Risk - CloseIT](https://www.closeit.co/eu-ai-act/) - EU AI Act compliance: who's affected, key deadlines (Aug 2026), high-risk categories, penalties, and...

15. [Prospect theory - Wikipedia](https://en.wikipedia.org/wiki/Prospect_theory) - Prospect theory is a theory of behavioral economics, judgment and decision making that was developed...

16. [Large language models show amplified cognitive biases in moral ...](https://pmc.ncbi.nlm.nih.gov/articles/PMC12207438/) - As large language models (LLMs) become more widely used, people increasingly rely on them to make or...

17. [RLHF Pipeline Overview - ApX Machine Learning](https://apxml.com/courses/llm-alignment-safety/chapter-2-reinforcement-learning-human-feedback-rlhf/rlhf-pipeline-components-workflow) - Stage 2: Reward Model Training. The core idea of RLHF is to learn human preferences. This is achieve...

18. [Reinforcement learning from human feedback - Wikipedia](https://en.wikipedia.org/wiki/Reinforcement_learning_from_human_feedback) - The reward model is first trained in a supervised manner to predict if a response to a given prompt ...

19. [Reward Models - by Cameron R. Wolfe, Ph.D.](https://cameronrwolfe.substack.com/p/reward-models) - Retraining the reward model needs additional training resources and it complicates the whole trainin...

20. [Multi Agent Architecture: Patterns, Use Cases & Production Reality](https://www.truefoundry.com/blog/multi-agent-architecture) - The orchestrator-worker pattern is one of the most common structures used in multi-agent systems. In...

21. [Choosing the right orchestration pattern for multi-agent systems](https://www.kore.ai/blog/choosing-the-right-orchestration-pattern-for-multi-agent-systems) - From centralized supervisors to adaptive mesh networks the orchestration pattern you choose shapes h...

22. [When does the EU AI Act take effect? | FluxForce](https://www.fluxforce.ai/answers/when-does-the-eu-ai-act-take-effect) - The EU AI Act entered into force on August 1, 2024 and applies in phases. Bans on prohibited AI syst...

23. [[PDF] AI Act: implications for the EU banking and payments sector](https://www.eba.europa.eu/sites/default/files/2025-11/d8b999ce-a1d9-4964-9606-971bbc2aaf89/AI%20Act%20implications%20for%20the%20EU%20banking%20sector.pdf) - The EBA's AI Act mapping exercise. In 2025, the EBA mapped the AI Act requirements on high-risk AI s...

24. ['Putting the human in the loop' – supervising AI use in Germany's ...](https://www.freshfields.com/en/our-thinking/blogs/technology-quotient/putting-the-human-in-the-loop-supervising-ai-use-in-germanys-financial-secto-102h6an) - Based on the principle of 'putting the human in the loop', BaFin expects people to be sufficiently i...

25. [AI Audit Trail: Compliance, Accountability & Evidence - Swept AI](https://www.swept.ai/ai-audit-trail) - An AI audit trail is a comprehensive, immutable record of AI system decisions, inputs, outputs, and ...
